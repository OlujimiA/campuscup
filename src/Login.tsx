        ...
        <div className="login-card w-full max-w-md p-8 rounded-lg shadow-xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm">
              Enter your credentials to enter the stadium.
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-[#1a061e] text-sm font-semibold mb-2">
                Email
              </label>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input-field w-full pl-10 pr-4 py-3 rounded-lg"
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full text-white font-bold py-4 rounded-lg uppercase tracking-widest"
            >
